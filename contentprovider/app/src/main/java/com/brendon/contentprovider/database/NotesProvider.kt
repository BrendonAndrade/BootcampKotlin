package com.brendon.contentprovider.database
...
import com.brendon.contentprovider.database.NotesDatabaseHelper.Companion.TABLE_NOTES
import java.net.URI
...
class NotesProvider : ContentProvider() {
    ...
    override fun insert(uri: Uri, values: ContentValues?): Uri? {
        if (mUriMatcher.match(uri) == NOTES){
            ...
            throw UnsupportedSchemeException("URL inválida para inclusão!")
        }
    }
    ...
    companion object {
        const val AUTHORITY = "com.brendon.contentprovider.provider"
